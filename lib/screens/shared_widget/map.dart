  ...
  searchChangedNavigate() {
    locationFromAddress(_textEditingController.text).then((res) async {
      _mapController.animateCamera(CameraUpdate.newCameraPosition(
          CameraPosition(
              target: LatLng(res[0].latitude, res[0].longitude), zoom: 10.0)));
    });
  }

  final CameraPosition _initialCamera =
      CameraPosition(target: LatLng(30.03, 31.23), zoom: 18);
          ...
          children: <Widget>[
            GoogleMap(
              ...
              onTap: (pos) async {
                ...
                var addresses = await placemarkFromCoordinates(pos.latitude, pos.longitude);
                setState(() {
                          ...
                          actions: <Widget>[
                            ...
                            FlatButton(
                              ...
                              onPressed: () {
                                ...
                                setState(() {
                                  widget.getAddress(_realAddressController.text,
              ...
              initialCameraPosition: CameraPosition(
                  target: LatLng(30.033333, 31.233334), zoom: 18),
            ),
            Positioned(
                top: 50,
                left: 0.0,
