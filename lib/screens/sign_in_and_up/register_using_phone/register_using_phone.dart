              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(translator.activeLanguageCode == "en" ?'Registration':'التسجيل',
                      style: infoWidget.title,),
                    SizedBox(height: 5,),
                    Text(translator.activeLanguageCode == "en" ?'Enter Your Mobile Number To Recieive A Verification Code':'ادخل رقم الهاتف لتستقبل كود التحقق',
                                ...
                                RaisedButton(
                                  onPressed: () {
                                    ...
                                    if(controller.text.trim().length ==12) {
                                      ...
                                      Toast.show(translator.activeLanguageCode == "en" ?'invalid phone number':'الرقم غير صحيح', context);
                                    }
                                  },
                                  color: Colors.indigo,
                                  child: Padding(
                                    ...
                                    child: Text(
                                      translator.activeLanguageCode == "en" ?'Get Code':'الحصول على الكود',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(
                            translator.activeLanguageCode == "en" ?'I have Account ':'امتلك حساب ',
                            style:
                          ...
                          InkWell(
                            ...
                            child: Text(
                              translator.activeLanguageCode == "en" ?'Sign In!':'تسجيل الدخول',
                              style: TextStyle(
                                  color: Colors.indigo,
                                  fontSize: 16,
