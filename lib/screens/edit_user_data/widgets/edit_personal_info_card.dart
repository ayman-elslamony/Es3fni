                  ...
                  ? Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          widget.email == ''
                              ? SizedBox()
                              : _data(title: translator.currentLanguage == "en" ?'Email:':'البريد الالكترونى: ', content: widget.email),
                          widget.phoneNumber == ''
                              ? SizedBox()
                              : InkWell(
                                  onTap: () {
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: _data(
                                            title: translator.currentLanguage == "en" ?'Phone Number:':'رقم الهاتف: ',
                          ...
                          widget.gender == ''
                              ? SizedBox()
                              : _data(title: translator.currentLanguage == "en" ?'Gender:':'النوع: ', content: widget.gender),
                          widget.governorate == ''
                              ? SizedBox()
                              : _data(
                                  title: translator.currentLanguage == "en" ?'Governorate:':'المحافظه: ',
