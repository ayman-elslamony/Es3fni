        ...
        builder: (BuildContext context) {
          return Container(
            ...
            child: Column(children: [
              Text(
                  translator.currentLanguage == "en" ?'Pick an Image':'التقط صوره',
                  style: TextStyle(
              ...
              Row(
                ...
                children: <Widget>[
                  FlatButton.icon(
                    ...
                    label: Text(
                      translator.currentLanguage == "en" ?'Use Camera':'استخدم الكاميرا',
                      style: TextStyle(
                  ...
                  FlatButton.icon(
                    ...
                    textColor: Theme.of(context).primaryColor,
                    label: Text(
                      translator.currentLanguage == "en" ?'Use Gallery':'استخدم المعرض',
                      style: TextStyle(
                          fontSize: MediaQuery.of(context).orientation==Orientation.portrait?MediaQuery.of(context).size.width * 0.035:MediaQuery.of(context).size.width * 0.024,
                          color: Colors.white,
                          fontWeight: FontWeight.bold),
    ...
    return Row(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              translator.currentLanguage == "en" ?"Select Image":'اختر صوره',
