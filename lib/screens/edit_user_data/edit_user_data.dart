...
class _EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    ...
    if (_auth.getUserType == 'nurse') {
      addList = translator.activeLanguageCode == "en"
                ...
                child: AlertDialog(
                  ...
                  content: Padding(
                    ...
                    child: InternationalPhoneNumberInput(
                      ...
                      hintText: translator.activeLanguageCode == "en"
                          ? 'phone number'
                          : 'رقم الهاتف',
                    ),
                  ),
                          ...
                          child: TextFormField(
                            ...
                            validator: (val) {
                              if (val.trim().length == 0) {
                                return translator.activeLanguageCode=='en'?'Please write some info':'من فضلك ادخل بعض البيانات';
                              }
                              if (val.trim() == _auth.userData.aboutYou) {
                                return translator.activeLanguageCode=='en'?'Already exists':'موجود بالفعل';
                              }
                            },
                          ),
                        ),
              ...
              child: AppBar(
                ...
                actions: <Widget>[
                  PopupMenuButton(
                    ...
                    initialValue: '',
                    tooltip:
                        translator.activeLanguageCode == "en" ? 'Select' : 'اختار',
