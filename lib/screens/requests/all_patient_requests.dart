              ...
              children: <Widget>[
                RaisedButton(
                  onPressed: ()async{
                    ...
                    if(x){
                      Toast.show(translator.activeLanguageCode == "en" ?"Successfully Deleted":'تم الحذف', context,
                          duration: Toast.LENGTH_SHORT,
                          gravity: Toast.BOTTOM);
                    }else{
                      Toast.show(translator.activeLanguageCode == "en" ?"Delete failed":'فشل الحذف', context,
                          duration: Toast.LENGTH_SHORT,
                          gravity: Toast.BOTTOM);
                    }
                  },
