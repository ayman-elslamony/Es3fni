...
class _AddRequestState extends State<AddRequest> {
 static GlobalKey<FormState> _newAccountKey = GlobalKey<FormState>();
  ...
  List<String> workingDays = translator.activeLanguageCode == "en"
      ?[
    'Saturday',
    'Sunday',
    'Monday',
...
//                      child: Text(
//                        translator.activeLanguageCode == "en"?'You need supplies from the pharmacy:':'تحتاج لمستلزمات من الصيدليه:',
