            ...
            children: <Widget>[
              ...
              _showPersonalInfo
                  ? Padding(
                    ...
                    child: Column(
                        children: <Widget>[
                          widget.email==''?SizedBox():_data(title:  translator.activeLanguageCode == "en" ?'Email:':'البريد الالكترونى: ', content: widget.email),
                         widget.phoneNumber==''?SizedBox(): _data(
                              title:  translator.activeLanguageCode == "en" ?'Phone Number:':'رقم الهاتف: ', content: widget.phoneNumber),
                          widget.address==''?SizedBox():_data(title:  translator.activeLanguageCode == "en" ?'Address:':'العنوان: ', content: widget.address),
                          widget.gender==''?SizedBox():_data(title:  translator.activeLanguageCode == "en" ?'Gender:':'النوع: ', content: widget.gender),
                          widget.governorate==''?SizedBox():_data(title:  translator.activeLanguageCode == "en" ?'Governorate:':'المحافظه: ', content: widget.governorate),
                        ],
                      ),
                  )
                  : SizedBox(),
